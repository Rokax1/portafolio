...
const FuzzyText: React.FC<FuzzyTextProps> = ({
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      const extraWidthBuffer = tightFit ? 0 : 10;
      ...
      const horizontalMargin = tightFit ? 0 : fuzzRange + 20;
      const verticalMargin = tightFit ? 0 : direction === 'vertical' || direction === 'both' ? fuzzRange + 10 : 0;
